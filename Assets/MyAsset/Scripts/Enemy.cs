...
public class Enemy : CellObject
{
    ...
    private void Awake()
    {
        GameManager.instance.m_turnPlayer.OnTick += TurnHappened;
    }
    ...
    bool MoveTo(Vector2Int coord)
    {
        ...
        if (targetCell == null
            || !targetCell.passable
            || targetCell.containGameObj != null)
        {
            return false;
        }
        ...
        currentCell.containGameObj = null;

        //add it to the next cell
        targetCell.containGameObj = this;
        m_Cell = coord;
    ...
    void TurnHappened()
    {
        ...
        var playerCell = GameManager.instance.player.m_CellPosition;
